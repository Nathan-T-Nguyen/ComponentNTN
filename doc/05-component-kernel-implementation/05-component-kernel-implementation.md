...
I will represent mt NoteSequence as an ArrayList<Note>, since it modles an ordered sequesnce, which is similar in structure to how sheet music is formatted. Kernel methods like inserting at a position, removing a note, and accessing a note at an index are efficient access.
